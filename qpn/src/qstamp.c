 ...
 * @note
 * This module needs to be re-compiled in every new software build. To achieve
...
extern char Q_ROM const Q_BUILD_DATE[12];
extern char Q_ROM const Q_BUILD_TIME[9];

/*! the calendar date of the last translation of the form: "Mmm dd yyyy" */
char Q_ROM const Q_BUILD_DATE[12] = __DATE__;

/*! the time of the last translation of the form: "hh:mm:ss" */
char Q_ROM const Q_BUILD_TIME[9] = __TIME__;
