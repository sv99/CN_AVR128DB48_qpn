 ...
 * @param[in] location of the assertion within the module. This could
 ...
 * system failure and its implementation should be very __carefully__
 ...
 * endless loop that ties up the CPU. During debugging, Q_onAssert() is an
